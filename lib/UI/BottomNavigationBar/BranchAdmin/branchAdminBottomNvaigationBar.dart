...
class BranchAdminBottomNavigationBarScreen extends StatefulWidget {
  const BranchAdminBottomNavigationBarScreen({super.key});

  @override
  State<BranchAdminBottomNavigationBarScreen> createState() => _HomePageState();
}

class _HomePageState extends State<BranchAdminBottomNavigationBarScreen> {
